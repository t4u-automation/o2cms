...
export async function getTenantInvitations(
  ...
  try {
    ...
    console.error("[O2] Error fetching invitations:", error);
    throw error;
  }
}
...
export async function createInvitation(
  ...
  try {
    ...
    console.log("[O2] Invitation created:", invitation.id);
    return invitation;
  } catch (error) {
    console.error("[O2] Error creating invitation:", error);
    throw error;
  }
}
...
export async function cancelInvitation(
  ...
  try {
    ...
    if (invitation.status !== "pending") {
      console.warn(
        `[O2] Invitation ${invitationId} is ${invitation.status}; cancel skipped.`
      );
      return;
    }
    ...
    console.log("[O2] Invitation cancelled:", invitationId);
  } catch (error) {
    console.error("[O2] Error cancelling invitation:", error);
    throw error;
  }
}
...
export async function resendInvitation(
  ...
  try {
    ...
    console.error("[O2] Error resending invitation:", error);
    throw error;
  }
}
